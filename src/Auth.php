...
class Auth {
    ...
    public function createOrder($params) {
		...
		$url = $this->isProductionMode() ?
			'https://transact.nab.com.au/services/order-management/v2/payments/orders' :
			'https://demo.transact.nab.com.au/services/order-management/v2/payments/orders';

		// Build request arguments.
        $response = $this->request('POST', $url, json_encode($params), 'json');
    ...
    public function processTransaction($data) {
		$url = $this->isProductionMode() ? 'https://transact.nab.com.au/live/xmlapi/payment' : 'https://demo.transact.nab.com.au/xmlapi/payment';
	 ...
	 * @param bool|string $decode false | 'json' | 'xml'
	 * @param any $data Data for POST method
	 *
	 * @return mixed
	 */
